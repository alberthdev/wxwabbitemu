...
ifeq ($(config),debug)
  ...
  CFLAGS    += $(CPPFLAGS) $(ARCH) -g -Wall -x c++ `wx-config --unicode=yes --version=2.8 --cxxflags`
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += `wx-config --unicode=yes --version=2.8 --libs richtext,aui,xrc,qa,html,adv,core,xml,net`
  LIBS      += 
...
ifeq ($(config),release)
  ...
  INCLUDES  += -I.. -I../core -I../debugger -I../gui -I../hardware -I../interface -I../utilities
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
  CFLAGS    += $(CPPFLAGS) $(ARCH) -O2 -x c++ `wx-config --unicode=yes --version=2.8 --cxxflags`
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -s `wx-config --unicode=yes --version=2.8 --libs richtext,aui,xrc,qa,html,adv,core,xml,net`
  LIBS      += 
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LDDEPS    += 
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(LDFLAGS) $(RESOURCES) $(ARCH) $(LIBS)
